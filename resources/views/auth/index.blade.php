...
<body class="bg-body-tertiary">
    <main class="container-fluid vh-100 d-flex align-items-center">
        <div class="container">
            ...
            <form id="login" class="form-signin" action="{{ route($route) }}" method="POST">
                @method('POST')
                @csrf
                ...
                @if (request()->is('register'))
                    <p class="text-center">Dengan membuat akun, Anda menyetujui <span class="text-danger">Ketentuan
                            Layanan</span> dan
