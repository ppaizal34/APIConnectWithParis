...
$(document).ready(function() {
    ...
    $(document).on("click", "#btn_random_api", function () {
        ...
        axios
            .get("http://127.0.0.1:8000/api/public/volcanoes/random")
            .then((response) => {
                const status = $(
    ...
    $(document).on("click", "#btn_all_api", function () {
        ...
        axios
            .get("http://127.0.0.1:8000/api/public/volcanoes")
            .then((response) => {
    ...
    $(document).on("click", "#btn_spesifik_api", function () {
        ...
        axios
            .get(`http://127.0.0.1:8000/api/public/volcanoes/${search_input}`)
            .then((response) => {
    ...
    $(document).on("click", "#btn_test_token", function () {
        ...
        axios
            .get(`http://127.0.0.1:8000/api/private/volcanoes/random`, {
                headers: {
