...
btn_all_api.addEventListener('click', function () {
    call_all_api("http://127.0.0.1:8000/api/public/heroes", this);
});

btn_random_api.addEventListener('click', function () {
    call_random_api('http://127.0.0.1:8000/api/public/heroes/random', this);
});

btn_spesifik_api.addEventListener('click', function () {
    call_spesifik_api(`http://127.0.0.1:8000/api/public/heroes/${search_input.value}`, this);
});

btn_test_token.addEventListener('click', function(){
    test_token(`http://127.0.0.1:8000/api/private/heroes/random`, this, token_input.value);
});
...
//         // Cek jika country input valuenya kosong
//         if(search_input.val() == ''){
//             const btn_spesifik_api = $('#btn_spesifik_api');
